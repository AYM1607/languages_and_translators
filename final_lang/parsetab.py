...
_lr_productions = [
  ...
  ('S -> parens id','S',2,'p_S','lex_yacc.py',159),
  ...
  ('S -> do id equals EA coma EA IntOrEmpty B end do','S',10,'p_S','lex_yacc.py',163),
  ('S -> do B end do','S',4,'p_S','lex_yacc.py',164),
