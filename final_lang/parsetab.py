...
_lr_productions = [
  ...
  ('S -> Dimensional action_7 equals EA action_8','S',5,'p_S','fort.py',205),
  ...
  ('action_5 -> <empty>','action_5',0,'p_action_5','fort.py',369),
  ('action_6 -> <empty>','action_6',0,'p_action_6','fort.py',374),
  ('action_7 -> <empty>','action_7',0,'p_action_7','fort.py',388),
  ('action_8 -> <empty>','action_8',0,'p_action_8','fort.py',393),
]
